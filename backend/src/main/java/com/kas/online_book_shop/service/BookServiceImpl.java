...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public Page<Book> getBooksByCollectionAndPriceRanges(BookCollection collection, BookCategory category, int min, int max,
            Pageable pageable) {
        return bookRepository.findByCategoryAndCollectionAndStateAndPriceBetween(
                category, collection, BookState.ACTIVE, min, max, pageable);
    }
